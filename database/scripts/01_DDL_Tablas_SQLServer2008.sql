...
BEGIN
    CREATE TABLE dbo.planillas_detalle (
        ...
        descuento_faltas DECIMAL(12,2) NOT NULL DEFAULT 0.00,
        descuento_pension DECIMAL(12,2) NOT NULL DEFAULT 0.00,
        aporte_essalud DECIMAL(12,2) NOT NULL DEFAULT 0.00,
